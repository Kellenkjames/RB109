...
The `puts` method invocation passes in the reference of `b` as an argument on line 14. Since `b` is not reassigned anywhere in the program; the output the Integer `2`; the method returns `nil`.
